      ...
      <div className="app">
        <Box maxWidth={600} marginTop={10}>
          <Box>
            ...
            <Typography variant="h5" color='secondary' fontWeight='bold'>Coding Challenge: Colors</Typography>
          </Box>
          <Box marginTop={4} paddingX={4}>
            <Typography color='secondary' align='justify'>
              ...
              32 steps (8, 16, 24, 256) which means you will have 32,768 discrete colours. For the full requirements and source code, please click <Link href={githubUrl} target='_blank' color='primary'>here</Link>.
            </Typography>
          </Box>
          <Box marginTop={4} paddingX={4}>
            <ColorCanvas />
